...
<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
	<h8 style="padding-top: 0px; padding-right: 15px; padding-bottom: 20px; padding-left: 45px">Email: <input type="type" name="email" /></h8><br />
	Password: <input type="password" name="password" /><br />
	<h8 style="padding-top: 20px; padding-right: 15px; padding-bottom: 20px; padding-left: 10px">First name: <input type="text" name="first_name" /></h8><br />
	<h8 style="padding-top: 20px; padding-right: 15px; padding-bottom: 20px; padding-left: 10px">Last name: <input type="text" name="last_name" /></h8><br />
	<h8 style="padding-top: 20px; padding-right: 35px; padding-bottom: 20px; padding-left: 0px">House Number: <input type="text" name="house_number" /></h8><br />
	<h8 style="padding-top: 20px; padding-right: 35px; padding-bottom: 20px; padding-left: 0px">Phone Number: <input type="text" name="phone" /></h8><br />
	<h8 style="padding-top: 20px; padding-right: 55px; padding-bottom: 20px; padding-left: 0px">Registration Code: <input type="text" name="invitecode" /></h8><br />
	<br>
