...
<div class="list-group list-group-alternate"> 
	<a href="financials.php" class="list-group-item"><font color=blue>Financials</font></a> 
	<a href="governing.php" class="list-group-item"><font color=blue>Governing Documents</font></a>
	<a href="minutes.php" class="list-group-item"><font color=blue>Meeting Minutes</font></a> 
</div>
			<h4><a href="home.php"><span class="label label-primary">Back</span></a></h4>
			     </center>
		</div>
		<?php } else { ?>
