...
<?php
	...
	<center><div class="column1"><div class="title">
				<span class="byline">Here you can download the Association’s governing documents. You can find the Articles of Incorporation, Bylaws, Covenants, Conditions & Restrictions (CC&Rs) and Resolutions.</span>
				 <li><a href="Files/Governing/Articles_Of_Incorporation.pdf"><font color="blue">Denney Road Articles of Incorporation (PDF)</font></a></li>
				 <li><a href="Files/Governing/CC_And_Rs.pdf"><font color="blue">Denney Road CC&R's (PDF)</font></a></li>
				 <li><a href="Files/Governing/Amendment_to_CC_And_Rs.pdf"><font color="blue">Amendment to Declaration of CC&R's (PDF)</font></a></li>
				 <li><a href="Files/Governing/Second_Amendment_to_CC_And_Rs.pdf"><font color="blue">Second Amendment to Declaration of CC&R's (PDF)</font></a></li>
				 <li><a href="Files/Governing/Denney_Road_Bylaws.pdf"><font color="blue">Denney Road Bylaws (PDF)</font></a></li>
				 <li><a href="Files/Governing/2007_Board_Resolution.pdf"><font color="blue">2007 Board Resolution (PDF)</font></a></li>
				 <li><a href="Files/Governing/Collection_Resolution.pdf"><font color="blue">Collection Resolution (PDF)</font></a></li>
			</div>
			
			
			 <a href="documents.php">Back</a>
			     </center>
		</div>
		</div>
	</div>
    ...
    <?php } else { ?>
        <p> We're sorry, you must be logged in to view this page. <a href="login.php">Login</a> </p>
    <?php
    }
?>
