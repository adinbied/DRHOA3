...
<body>
    ...
    ?>
				...
				<ol class="breadcrumb">
							...
							<li><a href="documents.php">Documents</a></li>
							<li class="active">Governing Documents</li>
						</ol>
						</div>
						<?php } else { ?>
       <br> <br> </div>
...
<?php
	...
	<a href="Files/Governing/Articles_Of_Incorporation.pdf" class="list-group-item"><font color="blue">Denney Road Articles of Incorporation (PDF)</font></a>
	<a href="Files/Governing/CC_And_Rs.pdf" class="list-group-item"><font color="blue">Denney Road CC&R's (PDF)</font></a>
	<a href="Files/Governing/Amendment_to_CC_And_Rs.pdf" class="list-group-item"><font color="blue">Amendment to Declaration of CC&R's (PDF)</font></a>
	<a href="Files/Governing/Second_Amendment_to_CC_And_Rs.pdf" class="list-group-item"><font color="blue">Second Amendment to Declaration of CC&R's (PDF)</font></a>
	<a href="Files/Governing/Denney_Road_Bylaws.pdf" class="list-group-item"><font color="blue">Denney Road Bylaws (PDF)</font></a>
	<a href="Files/Governing/2007_Board_Resolution.pdf" class="list-group-item"><font color="blue">2007 Board Resolution (PDF)</font></a>
	<a href="Files/Governing/Collection_Resolution.pdf" class="list-group-item"><font color="blue">Collection Resolution (PDF)</font></a>
</div>
			<h4><a href="documents.php"><span class="label label-primary">Back</span></a></h4>
			     </center>
			</div>
		</div>
		</div>
